...
export const defaultFormData: FormData = {
  ...
  jobTitle: {
    include: true,
    value: ['产品经理', '产品助理', '需求分析', 'PM', 'PO', '产品专员'],
    options: ['产品经理', '产品助理', '需求分析', 'PM', 'PO', '产品专员', '项目经理'],
    enable: true,
  },
  jobContent: {
    include: false,
    value: ['销售', '地推', '提成', '出车', '送货', '话务', '客服', '兼职', '实习', '驻场', '面销'],
    options: ['销售', '地推', '提成', '出车', '送货', '外包', '话务', '客服', '兼职', '实习', '驻场', '面销'],
    enable: true,
  },
  hrPosition: {
    include: true,
